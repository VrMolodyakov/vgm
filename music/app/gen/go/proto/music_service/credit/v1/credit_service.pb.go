...
func (x *CreateCreditRequest) GetAlbumId() string {
	if x != nil {
		return x.AlbumId
	}
	return ""
...
func (x *CreateCreditRequest) GetPersonId() int64 {
	if x != nil {
		return x.PersonId
	}
	return 0
...
func (x *CreateCreditRequest) GetProfession() string {
	if x != nil {
		return x.Profession
	}
	return ""
...
type FindCreditsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FindCreditsRequest) Reset() {
	*x = FindCreditsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_music_service_credit_v1_credit_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *FindCreditsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindCreditsRequest) ProtoMessage() {}

func (x *FindCreditsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_music_service_credit_v1_credit_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindCreditsRequest.ProtoReflect.Descriptor instead.
func (*FindCreditsRequest) Descriptor() ([]byte, []int) {
	return file_proto_music_service_credit_v1_credit_service_proto_rawDescGZIP(), []int{2}
}

func (x *FindCreditsRequest) GetAlbumId() string {
	if x != nil {
		return x.AlbumId
	}
	return ""
...
type FindCreditsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FindCreditsResponse) Reset() {
	*x = FindCreditsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_music_service_credit_v1_credit_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *FindCreditsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindCreditsResponse) ProtoMessage() {}

func (x *FindCreditsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_music_service_credit_v1_credit_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindCreditsResponse.ProtoReflect.Descriptor instead.
func (*FindCreditsResponse) Descriptor() ([]byte, []int) {
	return file_proto_music_service_credit_v1_credit_service_proto_rawDescGZIP(), []int{3}
}

func (x *FindCreditsResponse) GetCredits() []*Credit {
	if x != nil {
		return x.Credits
	}
	return nil
...
var file_proto_music_service_credit_v1_credit_service_proto_rawDesc = []byte{
	...
	0x6d, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x52,
	...
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x16,
	0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2f, 0x0a, 0x12, 0x46, 0x69, 0x6e, 0x64, 0x43, 0x72,
	0x65, 0x64, 0x69, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08,
	0x61, 0x6c, 0x62, 0x75, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x61, 0x6c, 0x62, 0x75, 0x6d, 0x49, 0x64, 0x22, 0x56, 0x0a, 0x13, 0x46, 0x69, 0x6e, 0x64, 0x43,
	0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f,
	...
	0x82, 0x02, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x79, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x72, 0x65, 0x64, 0x69,
	0x74, 0x12, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x5f,
	...
	,
	...
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x2f,
	0x76, 0x31, 0x3b, 0x70, 0x62, 0x5f, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x5f, 0x63, 0x72, 0x65, 0x64,
...
var file_proto_music_service_credit_v1_credit_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_music_service_credit_v1_credit_service_proto_goTypes = []interface{}{
	...
	(*FindCreditsRequest)(nil),   // 2: proto.music_service.credit.v1.FindCreditsRequest
	(*FindCreditsResponse)(nil),  // 3: proto.music_service.credit.v1.FindCreditsResponse
	(*Credit)(nil),               // 4: proto.music_service.credit.v1.Credit
}
var file_proto_music_service_credit_v1_credit_service_proto_depIdxs = []int32{
	4, // 0: proto.music_service.credit.v1.FindCreditsResponse.credits:type_name -> proto.music_service.credit.v1.Credit
	...
	2, // 2: proto.music_service.credit.v1.CreditService.FindCredits:input_type -> proto.music_service.credit.v1.FindCreditsRequest
	1, // 3: proto.music_service.credit.v1.CreditService.CreateCredit:output_type -> proto.music_service.credit.v1.CreateCreditResponse
	3, // 4: proto.music_service.credit.v1.CreditService.FindCredits:output_type -> proto.music_service.credit.v1.FindCreditsResponse
...
func file_proto_music_service_credit_v1_credit_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_music_service_credit_v1_credit_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindCreditsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_music_service_credit_v1_credit_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindCreditsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
